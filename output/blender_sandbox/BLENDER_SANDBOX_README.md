...
| sloped_assembled_reference | assembled reference mesh: A + B + 4 mm and 5 mm pins | 86.000 × 64.000 × 12.200 |
...
`sloped_assembled_reference` is the only deliberately assembled multi-part reference mesh. All other files remain separate for editing.
