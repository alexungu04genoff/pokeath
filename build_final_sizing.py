...
import analyse_board_sizes as study

ROOT=Path(__file__).resolve().parent
OUT=ROOT/'output'/'final_sizing_40mm'
PITCH=40.0
WELL=PITCH-2.0
RIM=3.0
CONFIGS={
...
def main():
    ...
    prior=json.loads((ROOT/'output/sizing/board_size_comparison.json').read_text())
    results=[]
    ...
    for source in (ROOT/'output/paper_art/stl').glob('fit_test_*.stl'):
