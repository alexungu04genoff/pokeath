...
from build_canonical_chassis import STANDARD, OUT, ROOT, preview
from build_printable_board import curved_rectangle
...
def main():
    ...
    import zipfile
    with zipfile.ZipFile(ROOT/'output/canonical_chassis_print_kit.zip','w',zipfile.ZIP_DEFLATED) as archive:
