...
The frozen production outputs are under `output/canonical_chassis/`. The production snap-key/rail dimensions remain those in `chassis_standard.json`; the experimental sloped lap-pin mechanism is deliberately excluded from this standard.
