...
from build_canonical_chassis import ROOT, STANDARD, export, fit_mesh, removal
from build_pin_joint_prototype import lug_profile, bore, pin, print_pin, intersection_volume, render, production_hashes, LOWER, UPPER

OUT=ROOT/'output/Melemele_pin_comparison'
...
def main():
    ...
    study=json.loads((ROOT/'output/sizing/board_size_comparison.json').read_text())
