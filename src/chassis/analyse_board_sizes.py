...
OUT=ROOT/'output'/'archive'/'sizing'
BED=250.0  # 3 mm nominal reserve per side on the A1
PITCH=131.5
BOARDS=[
    ('Akala','assets/boards/akala_adventure.png',448,45,8,12),
    ('Melemele','assets/boards/melemele_mile.png',150,310,11,8),
    ('Poni','assets/boards/poni_pass.png',255,118,11,10),
    ('Ulaula','assets/boards/ulaula_uproar.png',150,180,11,10),
]
