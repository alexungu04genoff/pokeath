...
OUT=ROOT/'output/CURRENT/A1_placement_preview'
...
def main(prototype_directory=None):
    ...
    prototype_directory=prototype_directory or ROOT/'output'/'CURRENT'/'prototype'/'sloped_lap_2x1'
    ...
    with zipfile.ZipFile(ROOT/'output/CURRENT/A1_placement_preview.zip','w',zipfile.ZIP_DEFLATED) as archive:
